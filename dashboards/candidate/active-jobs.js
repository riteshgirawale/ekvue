...
function ActiveJobsDashboard() {
  ...
  const loadJobsData = () => {
    ...
    // Fallback Mock items if empty (matches screenshot visual profiles exactly!)
    if (allJobs.length === 0) {
      allJobs = [
        {
          id: 'job_mock_1',
          ...
          status: 'Active',
          applied: 18,
          createdAt: new Date(Date.now() - 3600000 * 1).toISOString(), // 1 hr ago
          department: 'Engineering',
          employmentType: 'Full-time',
          workMode: 'Hybrid',
          experienceRequired: 'Mid Level',
          description: 'Build robust, highly scalable full stack applications. Design responsive web client layouts and integrate secure REST services.',
          skillsRequired: 'React.js, Node.js, MongoDB, JavaScript, Express.js',
          salary: '₹6 - ₹12 LPA',
          bonus: '10% performance incentive',
          benefits: 'Flexible Hours, Health Insurance, WFH Allowances',
          country: 'India',
          city: 'Pune'
        },
        {
          ...
          description: 'Design efficient backend schemas, optimize cache systems, and orchestrate service APIs with Docker container metrics.',
          skillsRequired: 'Node.js, Express.js, MySQL, Docker, AWS',
          salary: '₹7 - ₹14 LPA',
          bonus: 'Standard corporate benefits',
          benefits: 'Free Meals, Cab Facility, Medical Cover',
          country: 'India',
          city: 'Bangalore'
        },
        {
          ...
          description: 'Create user-focused design sheets, wireframe key customer paths, and translate specifications into clean interactive mockups.',
          skillsRequired: 'Figma, Adobe XD, UI Design, Wireframing, Prototyping',
          salary: '₹5 - ₹10 LPA',
          bonus: 'N/A',
          benefits: 'Flexible Leave, Gym Membership, Equipment Allowance',
          country: 'India',
          city: 'Hyderabad'
        },
        {
          ...
          workMode: 'Remote',
          experienceRequired: 'Mid Level',
          description: 'Engineer modern frontend layouts, align styled parameters with pixel-perfection, and manage app state patterns.',
          skillsRequired: 'React.js, JavaScript, Tailwind CSS, Redux, HTML',
          salary: '₹6 - ₹11 LPA',
          bonus: '12% performance incentive',
          benefits: 'WFH Allowance, Broadband Cover, Mental Wellness Program',
          country: 'India',
          city: 'Noida'
        }
      ];
      localStorage.setItem('ekvueCompanyItems', JSON.stringify(allJobs));
    }
